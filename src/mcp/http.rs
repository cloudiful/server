...
impl ServerConfig {
    ...
    fn service_path(&self) -> Result<&str, McpServerError> {
    ...
    S: ServerHandler + 'static,
{
    ...
    pub fn bind(self) -> Result<BoundServer, McpServerError> {
        ...
        let app = Self::build_router(runtime_config, service_factory)?;
    ...
    fn build_router(
        ...
        let service_path = runtime_config.service_path()?.to_string();
        let runtime_config = runtime_config.to_rmcp_config();
